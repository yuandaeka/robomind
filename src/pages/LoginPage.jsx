      ...
      >
        <div className="bg-white/95 backdrop-blur-xl rounded-[2rem] shadow-2xl p-8 border border-white/50">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-fredoka font-bold text-gray-900 mb-2">Selamat Datang!</h1>
            <p className="text-gray-500 font-outfit text-sm">Masuk ke akun Robo Mind Anda</p>
          </div>
